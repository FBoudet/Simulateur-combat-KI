...
Teteux_Parasite = {'pv': '30', 'carac': {'FOR':3,'PER':3,'INT':3,'CombatMainsNues':3,'CombatContact':2,'CombatDistance':3}, 'chgt_arme': 'True', 'styles': ('Lame Précise','Base Distance'), 'niveau': '(1,0)', 'armes': ('Couteau','Fronde'), 'armure': '0'},'True', 'styles': ('Lame Précise','Base Distance'), 'niveau': '(3,0)', 'armes': ('Épée Courte','Arc'), 'armure': '1'}
